...
def config():
    gmail_user = "upgradchatbot100@gmail.com"
    gmail_pwd = "ks@1234567890upgrad"  
...
def send_email(recipient, top_10_restaurant_df):
    msg = Message(subject="Restaurant Details provided by Foodie", sender=gmail_credentials[0], recipients=[recipient])
...
class SendMail(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        try:
            ...
            dispatcher.utter_message("Enjoy the food! Mail is sent.")
        except:
